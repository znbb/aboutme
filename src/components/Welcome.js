  ...
  render() {
    return (
        <div className="Welcome section">
            <h1 className="welcome-intro"><strong>Zara</strong> is a <strong>Software Engineer</strong> with over 4 years experience and is aspiring to become a <strong>Product Manager</strong></h1>
            <br/>
            <br/>
            ...
            <br/>
            <a href="https://drive.google.com/file/d/1YwQjAwHsRDTphMsDG5U6_h3XZUVdXIWj/view?usp=sharing" target="_blank" rel="noopener noreferrer"><button className="button resume-button">Resume <i className="fa fa-file-pdf-o" aria-hidden="true"/></button></a>
